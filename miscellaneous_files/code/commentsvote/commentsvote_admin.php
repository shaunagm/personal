...
if( $_POST[ 'save_options' ] > 0 )
{
	...
	{
		if( isset( $_POST[ $key ] ) )
			update_option( 'commentsvote_' . $key, 
...
value=\"$value\" $checked /> $label</label>";
}

?>
	
<div class="wrap">
	<h2>Comments Vote Admin</h2>

	<form 
action="options-general.php?page=commentsvote/commentsvote_admin.php" 
method="post">
		...
		<table class="form-table">
			<tr valign="top">
				...
				<?php
					echo 
makeRadioButton('display_rating', 'Yes', 1, 
$commentsvoteOptions['display_rating'] );
					echo ' &nbsp; ';
					echo 
makeRadioButton('display_rating', 'No', 0, 
!$commentsvoteOptions['display_rating'] );
				?>
				</td>
			</tr>
			...
			<tr valign="top">
				...
				<?php
					echo 
makeRadioButton('requier_login', 'Yes', 1, 
$commentsvoteOptions['require_login'] );
					echo ' &nbsp; ';
					echo 
makeRadioButton('requier_login', 'No', 0, 
!$commentsvoteOptions['require_login'] );
				?>
				</td>
			</tr>
...
value="<?php echo round( $commentsvoteOptions[ "threshold" ] ); ?>" 
size="3" /> <i>Negative rating at which comment will collapse. 0 = do 
not collapse</i></td>
			</tr>
